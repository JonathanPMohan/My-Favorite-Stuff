...
namespace MyFavoriteStuff
{
    class Program
    {
        ...
        {
            var zelda1 = new NesGames("The Legend of Zelda", "Action/RPG", 1987);

            var megaman2 = new NesGames("Mega Man 2", "Action/Adventure", 1989);

            var punchout = new NesGames("Mike Tyson's Punch Out", "Sports", 1987);
